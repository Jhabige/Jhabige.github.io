...
You can find full lists of my publications and some presentations based on recent research with my PhD students and collaborators. The tutorial below will walk you though the two basic strategies for HD testing multiple null hypotheses - the highly cited [BH procedure](https://academic.oup.com/jrsssb/article/57/1/289/7035855) for false discovery rate control with p-values and an empirical bayes analogue that uses posterior null probability estimates, also sometimes called local false discovery rates.  Questions posed in the tutorial hint at specific research areas in the field.  Many remain unanswered!
