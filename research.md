...
subtitle: 
---
I enjoy developing new statistical theory and methods the analysis of high dimensional (HD) data and count data. I'm particularly interested in multiple hypothesis testing methods for [false discovery rate (FDR) control](https://rss.onlinelibrary.wiley.com/doi/10.1111/j.2517-6161.1995.tb02031.x) with HD count data.  Such data often arise in the omics when high throughput sequencing technology is used to measures the abundance a gene, attributes, variables, etc. for thousands of genes on a relatively small number of samples. One goal may be to determine which variables are associated with covariate(s) or treatments, and we'd like to safeguard against a high rate of false positives. I'm also recently interested in replicability analysis and the impact of selection bias on downstream FDR estimation.  
